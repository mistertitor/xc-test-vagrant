...
XC-VendorMessages:
    ...
    dependencies: {  }
XPay-XPaymentsCloud:
    tables: [xpayments_fraud_check_data, bscriptionPlan, xpayments_subscription_plans, xpayments_subscriptions]
    columns: { orders: { xpaymentsFraudStatus: 'xpaymentsFraudStatus VARCHAR(255) NOT NULL', xpaymentsFraudType: 'xpaymentsFraudType VARCHAR(255) NOT NULL', xpaymentsFraudCheckTransactionId: 'xpaymentsFraudCheckTransactionId INT NOT NULL', buyWithApplePay: 'buyWithApplePay TINYINT(1) NOT NULL' }, order_items: { xpaymentsEmulated: 'xpaymentsEmulated TINYINT(1) NOT NULL', xpaymentsUniqueId: 'xpaymentsUniqueId VARCHAR(255) NOT NULL', subscriptionId: 'subscriptionId INT UNSIGNED DEFAULT NULL COMMENT ''Unique id''' }, profiles: { xpaymentsCustomerId: 'xpaymentsCustomerId VARCHAR(255) NOT NULL' } }
    dependencies: {  }
