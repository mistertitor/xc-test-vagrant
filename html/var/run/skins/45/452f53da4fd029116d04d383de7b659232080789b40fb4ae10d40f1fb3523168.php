...
/* /var/www/html/skins/admin/center.twig */
...
echo $templateWrapperStart;
        ...
        // line 6
        $this->loadTemplate("noscript.twig", "/var/www/html/skins/admin/center.twig", 6)->display($context);
        if ($templateWrapperText) {
...
echo $templateWrapperStart;
            ...
            $this->loadTemplate("access_denied.twig", "/var/www/html/skins/admin/center.twig", 21)->display($context);
            if ($templateWrapperText) {
                echo $this->getThis()->endMarker($fullPath, $templateWrapperText);
            }
        }
...
echo $templateWrapperStart;
            ...
            $this->loadTemplate("license_message.twig", "/var/www/html/skins/admin/center.twig", 25)->display($context);
            if ($templateWrapperText) {
                echo $this->getThis()->endMarker($fullPath, $templateWrapperText);
            }
        }
...
";
    ...
    {
        return "/var/www/html/skins/admin/center.twig";
    }
    ...
    {
        return new Source("", "/var/www/html/skins/admin/center.twig", "");
    }
}
