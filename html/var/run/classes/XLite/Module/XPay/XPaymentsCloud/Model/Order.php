 ...
 *
 */
 class Order extends \XLite\Module\XPay\XPaymentsCloud\Module\QSL\XPaymentsSubscriptions\Model\Order implements \XLite\Base\IDecorator
{
    /**
     * Fraud statuses
     */
    ...
    public function getCalculatedPaymentStatus($override = false)
    {
        ...
        if (PaymentStatus::STATUS_QUEUED == $result) {
            ...
            if ($lastTransaction && $lastTransaction->isXpayments()) {
    ...
    /**
     * Check if order has already paid subscriptions
     *
     * @return boolean
     */
    public function hasPaidXpaymentsSubscriptions()
    {
        $result = false;
