...
class Transaction extends \XLite\Model\Payment\Transaction implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getStripeTransferId($vendorId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getStripeTransferId', [$vendorId]);

        return parent::getStripeTransferId($vendorId);
    }
    ...
    public function getStripeChargeId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getStripeChargeId', []);

        return parent::getStripeChargeId();
    }
    ...
    public function isStripeConnect()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isStripeConnect', []);

        return parent::isStripeConnect();
    }
